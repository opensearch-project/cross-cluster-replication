...
class TransportValidatePermissionsAction @Inject constructor(transportService: TransportService,
        ...
        HandledTransportAction<ValidatePermissionsRequest, ValidatePermissionsResponse>(ValidatePermissionsAction.NAME,
    ...
    override fun doExecute(task: Task, request: ValidatePermissionsRequest, listener: ActionListener<ValidatePermissionsResponse>) {
        log.info("Replication setup - Permissions validation successful for Index - ${request.index} and role ${request.fgacRole}")
        listener.completeWith { ValidatePermissionsResponse(true) }
    }
