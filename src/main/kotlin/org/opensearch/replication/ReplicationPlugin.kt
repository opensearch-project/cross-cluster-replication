...
@OpenForTesting
internal class ReplicationPlugin :
    Plugin(),
    ActionPlugin,
    ...
    companion object {
        ...
        val REPLICATED_INDEX_SETTING: Setting<String> =
            Setting.simpleString(
                "index.plugins.replication.follower.leader_index",
                Setting.Property.InternalIndex,
                Setting.Property.IndexScope,
            )

        // Cluster-level batch size setting
        val REPLICATION_FOLLOWER_OPS_BATCH_SIZE: Setting<Int> =
            Setting.intSetting(
        ...
        val REPLICATION_FOLLOWER_OPS_BATCH_SIZE_INDEX: Setting<Int> =
            Setting.intSetting(
                "index.plugins.replication.follower.ops_batch_size",
                50000,
                MIN_OPS_BATCH_SIZE,
                Setting.Property.Dynamic,
                Setting.Property.IndexScope,
            )
        val REPLICATION_LEADER_THREADPOOL_SIZE: Setting<Int> =
            Setting.intSetting(
                "plugins.replication.leader.thread_pool.size",
                0,
                0,
                Setting.Property.Dynamic,
                Setting.Property.NodeScope,
            )
        val REPLICATION_LEADER_THREADPOOL_QUEUE_SIZE: Setting<Int> =
            Setting.intSetting(
                "plugins.replication.leader.thread_pool.queue_size",
                1000,
                0,
                Setting.Property.Dynamic,
                Setting.Property.NodeScope,
            )
        val REPLICATION_FOLLOWER_RECOVERY_CHUNK_SIZE: Setting<ByteSizeValue> =
            Setting.byteSizeSetting(
                "plugins.replication.follower.index.recovery.chunk_size",
                ByteSizeValue(10, ByteSizeUnit.MB),
                ByteSizeValue(1, ByteSizeUnit.MB),
                ByteSizeValue(1, ByteSizeUnit.GB),
                Setting.Property.Dynamic,
                Setting.Property.NodeScope,
            )
        val REPLICATION_FOLLOWER_RECOVERY_PARALLEL_CHUNKS: Setting<Int> =
            Setting.intSetting(
        ...
        val REPLICATION_FOLLOWER_CONCURRENT_READERS_PER_SHARD =
            Setting.intSetting(
                "plugins.replication.follower.concurrent_readers_per_shard",
                2,
                1,
                Setting.Property.Dynamic,
                Setting.Property.NodeScope,
            )
        val REPLICATION_FOLLOWER_CONCURRENT_WRITERS_PER_SHARD =
            Setting.intSetting(
        ...
        val REPLICATION_PARALLEL_READ_POLL_INTERVAL =
            Setting.timeSetting(
                "plugins.replication.follower.poll_interval",
        ...
        val REPLICATION_AUTOFOLLOW_REMOTE_INDICES_POLL_INTERVAL =
            Setting.timeSetting(
                "plugins.replication.autofollow.fetch_poll_interval",
        ...
        val REPLICATION_AUTOFOLLOW_REMOTE_INDICES_RETRY_POLL_INTERVAL =
            Setting.timeSetting(
                "plugins.replication.autofollow.retry_poll_interval",
                TimeValue.timeValueHours(1),
        ...
        val REPLICATION_METADATA_SYNC_INTERVAL =
            Setting.timeSetting(
                "plugins.replication.follower.metadata_sync_interval",
                TimeValue.timeValueSeconds(60),
                TimeValue.timeValueSeconds(5),
                Setting.Property.Dynamic,
                Setting.Property.NodeScope,
            )
        val REPLICATION_RETENTION_LEASE_MAX_FAILURE_DURATION =
            Setting.timeSetting(
                "plugins.replication.follower.retention_lease_max_failure_duration",
                TimeValue.timeValueHours(1),
                TimeValue.timeValueSeconds(1),
        ...
        val REPLICATION_INDEX_TRANSLOG_PRUNING_ENABLED_SETTING: Setting<Boolean> =
            Setting.boolSetting(
        ...
        val REPLICATION_INDEX_TRANSLOG_RETENTION_SIZE: Setting<ByteSizeValue> =
            Setting.byteSizeSetting(
                "index.plugins.replication.translog.retention_size",
                ByteSizeValue(512, ByteSizeUnit.MB),
                Setting.Property.Dynamic,
                Setting.Property.IndexScope,
            )
        val REPLICATION_FOLLOWER_BLOCK_START: Setting<Boolean> =
            Setting.boolSetting(
                "plugins.replication.follower.block.start",
                false,
                Setting.Property.Dynamic,
                Setting.Property.NodeScope,
            )
        val REPLICATION_AUTOFOLLOW_CONCURRENT_REPLICATION_JOBS_TRIGGER_SIZE: Setting<Int> =
            Setting.intSetting(
                "plugins.replication.autofollow.concurrent_replication_jobs_trigger_size",
                3,
                1,
                10,
                Setting.Property.Dynamic,
        ...
        val REPLICATION_REPLICATE_INDEX_DELETION: Setting<Boolean> =
            Setting.boolSetting(
                "plugins.replication.replicate.delete_index",
                false,
                Setting.Property.Dynamic,
                Setting.Property.NodeScope,
            )
    ...
    override fun createComponents(
        ...
        repositoriesService: Supplier<RepositoriesService>,
    ): Collection<Any> {
        this.client = client
        this.threadPool = threadPool
        this.clusterService = clusterService
        this.replicationMetadataManager =
    ...
    override fun getGuiceServiceClasses(): Collection<Class<out LifecycleComponent>> =
        listOf(
            Injectables::class.java,
            RemoteClusterStats::class.java,
    ...
    override fun getActions(): List<ActionHandler<out ActionRequest, out ActionResponse>> =
        listOf(
            ActionHandler(GetChangesAction.INSTANCE, TransportGetChangesAction::class.java),
    ...
    override fun getExecutorBuilders(settings: Settings): List<ExecutorBuilder<*>> =
        listOf(followerExecutorBuilder(), leaderExecutorBuilder(settings))

    private fun followerExecutorBuilder(): ExecutorBuilder<*> =
        ScalingExecutorBuilder(REPLICATION_EXECUTOR_NAME_FOLLOWER, 1, 10, TimeValue.timeValueMinutes(1), REPLICATION_EXECUTOR_NAME_FOLLOWER)
    ...
    private fun leaderExecutorBuilder(settings: Settings): ExecutorBuilder<*> {
        ...
        return FixedExecutorBuilder(
            settings,
            REPLICATION_EXECUTOR_NAME_LEADER,
            leaderThreadPoolSize,
            leaderThreadPoolQueueSize,
            REPLICATION_EXECUTOR_NAME_LEADER,
        )
    }

    private fun leaderThreadPoolSize(allocatedProcessors: Int): Int = allocatedProcessors * 3 / 2 + 1
    ...
    override fun getPersistentTasksExecutor(
        ...
        listOf(
            ShardReplicationExecutor(
                REPLICATION_EXECUTOR_NAME_FOLLOWER,
                clusterService,
                threadPool,
                client,
                replicationMetadataManager,
    ...
    override fun getNamedWriteables(): List<NamedWriteableRegistry.Entry> =
        listOf(
            NamedWriteableRegistry.Entry(
                PersistentTaskParams::class.java,
                ShardReplicationParams.NAME,
    ...
    override fun getSettings(): List<Setting<*>> =
        listOf(
            ...
            REPLICATION_FOLLOWER_OPS_BATCH_SIZE,
            REPLICATION_FOLLOWER_OPS_BATCH_SIZE_INDEX,
            REPLICATION_LEADER_THREADPOOL_SIZE,
            REPLICATION_LEADER_THREADPOOL_QUEUE_SIZE,
            REPLICATION_FOLLOWER_CONCURRENT_READERS_PER_SHARD,
            REPLICATION_FOLLOWER_RECOVERY_CHUNK_SIZE,
            REPLICATION_FOLLOWER_RECOVERY_PARALLEL_CHUNKS,
            REPLICATION_PARALLEL_READ_POLL_INTERVAL,
            REPLICATION_AUTOFOLLOW_REMOTE_INDICES_POLL_INTERVAL,
            REPLICATION_AUTOFOLLOW_REMOTE_INDICES_RETRY_POLL_INTERVAL,
            REPLICATION_METADATA_SYNC_INTERVAL,
            ...
            REPLICATION_FOLLOWER_BLOCK_START,
            REPLICATION_AUTOFOLLOW_CONCURRENT_REPLICATION_JOBS_TRIGGER_SIZE,
            REPLICATION_FOLLOWER_CONCURRENT_WRITERS_PER_SHARD,
            REPLICATION_REPLICATE_INDEX_DELETION,
        )

    override fun getInternalRepositories(
        env: Environment,
        namedXContentRegistry: NamedXContentRegistry,
        clusterService: ClusterService,
        recoverySettings: RecoverySettings,
    ): Map<String, Repository.Factory> {
        val repoFactory =
            Repository.Factory { repoMetadata: RepositoryMetadata ->
                RemoteClusterRepository(
                    repoMetadata,
                    client,
                    clusterService,
                    recoverySettings,
    ...
    override fun getEngineFactory(indexSettings: IndexSettings): Optional<EngineFactory> =
        if (indexSettings.settings.get(REPLICATED_INDEX_SETTING.key) != null) {
            Optional.of(
    ...
    override fun getCustomTranslogDeletionPolicyFactory(): Optional<TranslogDeletionPolicyFactory> {
        ...
        return if (ValidationUtil.isRemoteEnabledOrMigrating(clusterService) == false) {
            Optional.of(
                TranslogDeletionPolicyFactory { indexSettings, retentionLeasesSupplier ->
