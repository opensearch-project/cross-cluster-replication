...
class LeaderStatsHandler : BaseRestHandler() {
    ...
    override fun routes(): List<RestHandler.Route> =
        listOf(RestHandler.Route(RestRequest.Method.GET, "/_plugins/_replication/leader_stats"))

    override fun getName(): String = "plugins_leader_replication_stats"
    ...
    override fun prepareRequest(
        ...
        return RestChannelConsumer { channel: RestChannel? ->
            client
                ...
                .cluster()
                .execute(
                    LeaderStatsAction.INSTANCE,
                    statsRequest,
                    object : RestResponseListener<LeaderStatsResponse>(channel) {
