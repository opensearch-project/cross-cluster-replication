...
class PauseIndexReplicationHandler : BaseRestHandler() {
    ...
    override fun routes(): List<RestHandler.Route> =
        listOf(RestHandler.Route(RestRequest.Method.POST, "/_plugins/_replication/{index}/_pause"))

    override fun getName(): String = "plugins_index_pause_replicate_action"
