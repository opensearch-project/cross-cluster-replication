...
class FollowerStatsHandler : BaseRestHandler() {
    ...
    override fun routes(): List<RestHandler.Route> =
        listOf(RestHandler.Route(RestRequest.Method.GET, "/_plugins/_replication/follower_stats"))

    override fun getName(): String = "plugins_follower_replication_stats"
