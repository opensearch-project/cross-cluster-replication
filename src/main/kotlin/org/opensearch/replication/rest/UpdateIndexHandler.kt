...
class UpdateIndexHandler : BaseRestHandler() {
    override fun routes(): List<RestHandler.Route> =
        listOf(RestHandler.Route(RestRequest.Method.PUT, "/_plugins/_replication/{index}/_update"))

    override fun getName(): String = "plugins_index_update_replicate_action"
    ...
    override fun prepareRequest(
        ...
        updateSettingsRequest.clusterManagerNodeTimeout(
            request.paramAsTime("master_timeout", updateSettingsRequest.clusterManagerNodeTimeout()),
        )
