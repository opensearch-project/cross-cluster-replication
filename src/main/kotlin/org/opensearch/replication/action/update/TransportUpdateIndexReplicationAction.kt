...
class TransportUpdateIndexReplicationAction
    @Inject
    constructor(
    ...
    ) : TransportClusterManagerNodeAction<UpdateIndexReplicationRequest, AcknowledgedResponse>(
            UpdateIndexReplicationAction.NAME,
            transportService,
            clusterService,
            threadPool,
            actionFilters,
            ::UpdateIndexReplicationRequest,
        ...
        override fun checkBlock(
            request: UpdateIndexReplicationRequest,
            state: ClusterState,
