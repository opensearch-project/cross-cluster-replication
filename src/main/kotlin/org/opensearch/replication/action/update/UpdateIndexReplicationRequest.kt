...
class UpdateIndexReplicationRequest :
    ...
    companion object {
        private val PARSER =
            ObjectParser<UpdateIndexReplicationRequest, Void>("FollowIndexRequestParser") { UpdateIndexReplicationRequest() }
        ...
        ): UpdateIndexReplicationRequest = throw IOException("Not supported for $this")
    }
