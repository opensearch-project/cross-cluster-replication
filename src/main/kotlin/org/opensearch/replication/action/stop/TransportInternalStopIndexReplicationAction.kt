 ...
 */
class TransportInternalStopIndexReplicationAction
    @Inject
    constructor(
        val name: String,
    ...
    ) : HandledTransportAction<ActionRequest, AcknowledgedResponse>(
        ...
        override fun doExecute(
            ...
            launch(Dispatchers.Unconfined + threadPool.coroutineContext()) {
                val transformedRequest =
                    if (request is StopIndexReplicationRequest) {
                        request
                    } else {
                ...
                try {
                    ...
                    log.info(
                        "Stop replication successful for index[${transformedRequest.indexName}] with response: " + response.isAcknowledged,
                    )
