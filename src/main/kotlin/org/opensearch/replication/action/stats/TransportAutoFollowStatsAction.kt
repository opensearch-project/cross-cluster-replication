...
class TransportAutoFollowStatsAction
    @Inject
    constructor(
        ...
        actionFilters: ActionFilters,
            ...
            transportService,
            actionFilters,
            ::AutoFollowStatsRequest,
            ::AutoFollowStatsResponses,
        ...
        override fun newResponse(
            request: AutoFollowStatsRequest,
            resp: MutableList<AutoFollowStatsResponse>,
            failure: MutableList<TaskOperationFailure>,
            failedNode: MutableList<FailedNodeException>,
        ): AutoFollowStatsResponses = AutoFollowStatsResponses(resp, failedNode, failure)

        override fun taskOperation(
            req: AutoFollowStatsRequest,
            task: AutoFollowTask,
            listener: ActionListener<AutoFollowStatsResponse>,
        ) {
