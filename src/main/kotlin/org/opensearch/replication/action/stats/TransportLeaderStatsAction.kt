...
class TransportLeaderStatsAction
    @Inject
    constructor(
        ...
        private val client: NodeClient,
    ) : TransportNodesAction<LeaderStatsRequest, LeaderStatsResponse, NodeStatsRequest, LeaderNodeStatsResponse>(
            LeaderStatsAction.NAME,
            threadPool,
            clusterService,
            transportService,
            actionFilters,
            ...
            LeaderNodeStatsResponse::class.java,
        ),
        ...
        override fun newNodeRequest(request: LeaderStatsRequest): NodeStatsRequest = NodeStatsRequest()

        override fun newNodeResponse(input: StreamInput): LeaderNodeStatsResponse = LeaderNodeStatsResponse(input)

        override fun newResponse(
            request: LeaderStatsRequest?,
            responses: MutableList<LeaderNodeStatsResponse>?,
            failures: MutableList<FailedNodeException>?,
        ): LeaderStatsResponse = LeaderStatsResponse(clusterService.clusterName, responses, failures)
