...
class ReplicateIndexRequest :
    AcknowledgedRequest<ReplicateIndexRequest>,
    ...
    companion object {
        ...
        init {
            ...
            INDEX_REQ_PARSER.declareObjectOrDefault(
                BiConsumer { reqParser: ReplicateIndexRequest, roles: HashMap<String, String> ->
                    reqParser.useRoles =
                        roles
                },
                FGAC_ROLES_PARSER,
    ...
    override fun indices(): Array<String?> = arrayOf(followerIndex)
