...
class TransportUpddateIndexBlockAction
    @Inject
    constructor(
        ...
        val client: Client,
    ) : TransportClusterManagerNodeAction<UpdateIndexBlockRequest, AcknowledgedResponse>(
            UpdateIndexBlockAction.NAME,
            transportService,
            clusterService,
            threadPool,
            actionFilters,
        ...
        override fun checkBlock(
            request: UpdateIndexBlockRequest?,
            state: ClusterState,
        ...
        private suspend fun addIndexBlockForReplication(request: UpdateIndexBlockRequest): AcknowledgedResponse {
            val addIndexBlockTaskResponse: AcknowledgedResponse =
                clusterService.waitForClusterStateUpdate("add-block") { l ->
