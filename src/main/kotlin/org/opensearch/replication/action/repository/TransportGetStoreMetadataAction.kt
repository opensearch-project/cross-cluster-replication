...
class TransportGetStoreMetadataAction
    @Inject
    constructor(
    ...
    ) : TransportSingleShardAction<GetStoreMetadataRequest, GetStoreMetadataResponse>(
            GetStoreMetadataAction.NAME,
            threadPool,
            clusterService,
            transportService,
            actionFilters,
        ...
        override fun shardOperation(
            request: GetStoreMetadataRequest,
            shardId: ShardId,
        ...
        override fun resolveIndex(request: GetStoreMetadataRequest): Boolean = true

        override fun getResponseReader(): Writeable.Reader<GetStoreMetadataResponse> =
            Writeable.Reader { inp: StreamInput -> GetStoreMetadataResponse(inp) }
