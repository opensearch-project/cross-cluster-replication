...
class TransportUpdateReplicationStateDetails
    @Inject
    constructor(
    ...
    ) : TransportClusterManagerNodeAction<UpdateReplicationStateDetailsRequest, AcknowledgedResponse>(
            UpdateReplicationStateAction.NAME,
            transportService,
            clusterService,
            threadPool,
            actionFilters,
        ...
        override fun clusterManagerOperation(
            ...
            launch(threadPool.coroutineContext(ThreadPool.Names.MANAGEMENT)) {
                listener.completeWith {
                    submitClusterStateUpdateTask(
                        request,
                        UpdateReplicationStateDetailsTaskExecutor.INSTANCE
