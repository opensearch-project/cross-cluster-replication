...
class TransportValidatePermissionsAction @Inject constructor(
    transportService: TransportService,
    val threadPool: ThreadPool,
    actionFilters: ActionFilters,
    private val client: Client,
) :
    HandledTransportAction<ValidatePermissionsRequest, AcknowledgedResponse>(
        ValidatePermissionsAction.NAME,
