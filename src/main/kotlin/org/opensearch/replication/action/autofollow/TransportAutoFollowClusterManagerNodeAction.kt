...
class TransportAutoFollowClusterManagerNodeAction @Inject constructor(
    ...
    TransportClusterManagerNodeAction<AutoFollowClusterManagerNodeRequest, AcknowledgedResponse>(
        ...
        ::AutoFollowClusterManagerNodeRequest, indexNameExpressionResolver,
    ),
            ...
            listener.completeWith {
                ...
                if (request.action == UpdateAutoFollowPatternRequest.Action.ADD) {
                    ...
                    metadataManager.addAutofollowMetadata(
                        request.patternName, request.connection, request.pattern!!,
    ...
    private suspend fun startAutoFollowTask(clusterAlias: String, patternName: String) {
        try {
            val response = persistentTasksService.startTask(
