...
class UpdateAutoFollowPatternRequest :
    AcknowledgedRequest<UpdateAutoFollowPatternRequest>,
    ToXContentObject {
    ...
    companion object {
        private val AUTOFOLLOW_REQ_PARSER =
            ObjectParser<UpdateAutoFollowPatternRequest, Void>("AutoFollowRequestParser") { UpdateAutoFollowPatternRequest() }
        ...
        init {
            ...
            AUTOFOLLOW_REQ_PARSER.declareObjectOrDefault(
                BiConsumer {
                    reqParser: UpdateAutoFollowPatternRequest,
    ...
    override fun validate(): ActionRequestValidationException? {
        ...
        if (useRoles != null && (
                useRoles!!.size < 2 || useRoles!![ReplicateIndexRequest.LEADER_CLUSTER_ROLE] == null ||
