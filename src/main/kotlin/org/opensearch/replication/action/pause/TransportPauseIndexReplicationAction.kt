...
class TransportPauseIndexReplicationAction
    @Inject
    constructor(
    ...
    ) : TransportClusterManagerNodeAction<PauseIndexReplicationRequest, AcknowledgedResponse>(
        ...
        override fun checkBlock(
            request: PauseIndexReplicationRequest,
            state: ClusterState,
                ...
                listener.completeWith {
                    ...
                    if (restoring) {
                        throw OpenSearchException(
                            "Index is in restore phase currently for index: ${request.indexName}. You can pause after restore completes.",
                        )
                    }
