...
class IndexReplicationExecutor(
    ...
    override fun validate(
        ...
        val replicationStateParams =
            getReplicationStateParamsForIndex(clusterService, params.followerIndexName)
        ...
        if (replicationStateParams[REPLICATION_LAST_KNOWN_OVERALL_STATE] != ReplicationOverallState.RUNNING.name) {
            throw IllegalArgumentException(
                "Replication state for index:${params.followerIndexName} should be RUNNING, " +
                    "but was:${replicationStateParams[REPLICATION_LAST_KNOWN_OVERALL_STATE]}",
            )
        }
    }

    override fun nodeOperation(
        task: AllocatedPersistentTask,
        params: IndexReplicationParams,
    ...
    override fun createTask(
        ...
        return IndexReplicationTask(
            ...
            threadPool,
            client,
            requireNotNull(taskInProgress.params),
