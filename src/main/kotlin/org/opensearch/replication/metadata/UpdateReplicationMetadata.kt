...
class UpdateReplicationStateDetailsTaskExecutor private constructor() :
    ...
    override fun execute(currentState: ClusterState, tasks: List<UpdateReplicationStateDetailsRequest>): ClusterStateTaskExecutor.ClusterTasksResult<UpdateReplicationStateDetailsRequest> {
