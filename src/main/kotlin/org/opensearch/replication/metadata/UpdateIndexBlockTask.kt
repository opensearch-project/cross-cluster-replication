...
*/
fun checkIfIndexBlockedWithLevel(
    ...
    val writeIndexBlockMap: Map<String, Set<ClusterBlock>> =
        clusterService
            .state()
            .blocks()
...
class UpdateIndexBlockTask(
    val request: UpdateIndexBlockRequest,
