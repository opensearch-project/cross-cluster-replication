...
class SingleClusterSanityIT : MultiClusterRestTestCase() {
    companion object {
        ...
        private const val FOLLOWER_CLUSTER_NAME = "followCluster"
        ...
        fun setupTestClusters() {
            ...
            clusters.put(FOLLOWER_CLUSTER_NAME, createTestCluster(FOLLOWER_CLUSTER_NAME, true, true, true, false))
    ...
    fun basicReplicationSanityWithSingleCluster() {
        verifyReplicationPluginInstallationOnAllNodes(FOLLOWER_CLUSTER_NAME)
        verifyReplicationApis(FOLLOWER_CLUSTER_NAME)
    }
    ...
    private fun verifyReplicationApis(clusterName: String) {
        val follower = getClientForCluster(FOLLOWER_CLUSTER_NAME)
        assertThatThrownBy {
        ...
        assertThatThrownBy {
            follower.stopReplication(FOLLOWER_CLUSTER_NAME)
        }.isInstanceOf(ResponseException::class.java)
            .hasMessageContaining("No replication in progress for index:" + FOLLOWER_CLUSTER_NAME)
    }
}
