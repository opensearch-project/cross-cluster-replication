        ...
        if (action == UpdateSettingsAction.INSTANCE) {
            ...
            var t1 =
                PersistentTaskResponse(
                    PersistentTasksCustomMetadata.PersistentTask<ShardReplicationParams>(
                        UUIDs.base64UUID(),
            ...
            val replicationMetadata =
                ReplicationMetadata(
                    IndexReplicationTaskTests.connectionName,
                    ReplicationStoreMetadataType.INDEX.name,
                    "overallState.name",
                    ReplicationMetadataManager.CUSTOMER_INITIATED_ACTION,
            ...
            var result =
                GetResult(
                    ...
                    IndexReplicationTaskTests.followerIndex,
                    1,
                    1,
                    1,
                    true,
